...
document.write(
  "<br><br>" +
    "<table><tr><th>Subjects</th><th>Total Marks</th><th>Obatined Marks</th><th>Percentage</th></tr><tr><td>" +
    sub1 +
    "</td><td>" +
    totalMarks +
    "</td><td>" +
...
colors.shift();
document.write(
  "Colors after remove first one" + "<br>" + colors + "<br>" + "<br>"
);

colors.pop();
document.write(
  "Colors after remove last one" + "<br>" + colors + "<br>" + "<br>"
);
...
document.write(
  "Colors after Adding new color " + "<br>" + colors + "<br>" + "<br>"
);
...
document.write(
  "Colors after delete colors " + "<br>" + colors + "<br>" + "<br>"
);

var studentsScore = [159, 285, 221, 377, 345, 120];
studentsScore.sort();
document.write(
  "Array after Sorting" + "<br>" + studentsScore + "<br>" + "<br>"
);

var cities = ["karachi", "islamabad", "quetta", "peshawer", "lahore"];
var selectedCities = cities.slice(0, 3);
document.write(
  "Array Of selected Cities" + "<br>" + selectedCities + "<br>" + "<br>"
);
